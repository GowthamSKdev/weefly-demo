    ...
    <div className="flex flex-col lg:flex-row px-6 xl:px-40 justify-center items-center  lg:min-h-screen bg-white text-black font-sans">
      ...
      <div className="w-full lg:w-1/2 flex justify-center items-center py-12">
        <div className="max-w-md w-full justify-center text-center lg:text-left lg:space-y-4">
          ...
          <h2 className="text-[32px] lg:text-[40px] font-semibold font-jakarta">
            WEEFLY TRAVEL AI
          </h2>
          <p className="text-xl lg:text-3xl font-sans text-gray-700 font-normal">
            Your travel companion
          </p>
          <button className="mt-10 lg:mt-14 px-8 py-2 text-lg font-jakarta font-semibold bg-[#EE5128] text-white rounded-md hover:bg-orange-700 transition">
            Learn more
          </button>
        </div>
      </div>
