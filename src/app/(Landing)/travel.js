...
//     <section
//   style={{
//     opacity: scrollY < 300 ? 1 : Math.max(1 - (scrollY - 300) / 500, 0),
...
//         {/* ✅ Background */}
//         <div className="relative bg-cover bg-center px-4 sm:px-6 md:px-8 lg:px-24 pt-20 pb-20 lg:pt-10 lg:pb-10 z-10"
//           style={{
//             backgroundImage: "url('/assets/travel/bg-pattern.png')",
...
//     <Image
//       src="/assets/travel/vector-2.png"
//       alt="Curved Card"
//       width={650}
//       height={450}
...
//   Be Part Of The African<br />
//   <span className="font-semibold text-black lg:text-[40px]">Travel Tech Revolution</span>
// </h2>
...
//   <div
//     key={text}
//     className={`flex items-center justify-start gap-x-3 ${text === 'Apply for Partnership' ? 'mt-[4px]' : ''}`}
//   >
//     {/* Text + Underline */}
...
//             {/* Top Travel Image */}
//             <div className="rounded-xl overflow-hidden mb-[-36px] mx-auto max-w-[100%]" style={{ maxWidth: '370px' }}>
//               <Image
//                 src="/assets/travel/travel.png"
//                 alt="Traveler"
//                 width={367}
...
//                           <a
//                             href="/your-link"
//                             className={`w-[24px] h-[24px] flex items-center justify-center rounded-full border border-[#F15623] text-[#F15623] hover:bg-[#F15623] hover:text-white transition ${idx === 0 || idx === 2 ? 'ml-[2px]' : ''} ${idx === 1 ? 'ml-[10px]' : ''}`}
//                           >
...
//     <Image
//       src="/assets/travel/bg-pattern.png"
...
//   {/* Vector Card */}
//   <div className="relative" style={{ width: '420px', height: '230px', transform: 'translate(-59px, 100px)' }}>
//     <Image
//       src="/assets/travel/vector-2.png"
//       alt="Curved Card"
//       fill
...
//   {/* Vector Card */}
//   <div className="relative" style={{ width: '420px', height: '230px', transform: 'translate(-105px, 170px)' }}>
//     <Image
//       src="/assets/travel/vector-2.png"
//       alt="Curved Card"
//       fill
...
//           <Image
//             src="/assets/travel/bottopwrap.png"
//             alt="Bottom Wrap"
//             width={1920}
//             height={100}
//             className="w-full object-cover"
...
//           <Image
//             src="/assets/travel/bottomwrap.png"
...
export default function ContactUsSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className={`relative min-h-[140vh] bg-white flex items-center transition-all duration-1000 ease-out ${
        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
      }`}
    >
      {/* ✅ Background */}
      <div
        className="relative w-full px-6 sm:px-8 md:px-10 lg:px-24 pt-24 pb-24 bg-cover bg-center"
        style={{
          backgroundImage: "url('/assets/travel/bg-pattern.png')",
          backgroundRepeat: "no-repeat",
          backgroundSize: "cover",
      ...
      >
        {/* ✅ Content Layout */}
        <div className="max-w-[1350px] mx-auto flex flex-col lg:flex-row items-center gap-10">
          ...
          {/* Right Content */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl lg:text-4xl font-jakarta text-[#0F172A] mb-6">
              Be Part Of The African<br />
              <span className="font-bold text-black">Travel Tech Revolution</span>
            </h2>

            {/* Buttons */}
            <div className="grid grid-cols-2 gap-5">
              {["Become an Agent", "Register as Vendor", "Apply for Partnership"].map((text, idx) => (
                <div key={idx} className="flex items-center gap-2">
                  <span className="text-[#F15623] font-semibold text-[18px]">{text}</span>
                  <a
                    href="/your-link"
                    className="flex items-center justify-center rounded-full border border-[#F15623] text-[#F15623] hover:bg-[#F15623] hover:text-white transition"
            ...
            {/* Contact Button */}
            <div className="mt-10">
              <button className="bg-[#F15623] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#d54417] transition">
                Contact us
              </button>
            </div>
          </div>
