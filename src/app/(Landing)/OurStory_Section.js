  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex max-w-[1200px] mx-auto items-center justify-between gap-12 relative z-10">
        <div className={`w-full md:w-[60%] text-center md:text-left px-2 sm:px-4 md:px-0 transition-all duration-1000 ease-in-out ${textAnimationClass}`}>
          <h4 className="text-lg font-jakarta text-[#0F172A] mb-1">Our Story</h4>
          <h2 className="text-4xl font-jakarta text-[#F15623] font-semibold mb-5 leading-snug">
            Born in Africa, Built for<br className="hidden md:inline" /> the World
          </h2>
          <p className="text-base text-gray-700 font-lato mb-6 leading-[1.7rem] tracking-tight">
            What started as a simple idea for making travel across Africa easier, smarter, and more connected,
            has now taken form into a powerful and comprehensive booking platform.
        ...
        <div className={`w-full md:w-[40%] relative flex justify-center md:justify-end mt-8 md:mt-0 transition-all duration-1000 ease-in-out ${imageAnimationClass}`}>
